...
export default function AnalyticsTasks({ title, subheader, list, ...other }: AnalyticsTasksProps) {
    ...
    <>
      ...
      >
        <MenuItem onClick={handleMarkComplete}>
          <Iconify icon="eva:checkmark-circle-2-fill" sx={{ marginRight: 2 }} />
          Mark Complete
        </MenuItem>
        ...
        <MenuItem onClick={handleShare}>
          <Iconify icon="solar:share-bold" sx={{ marginRight: 2 }} />
          Share
        </MenuItem>

        <MenuItem onClick={handleDelete} sx={{ color: 'error.main' }}>
          <Iconify icon="solar:trash-bin-trash-bold" sx={{ marginRight: 2 }} />
          Delete
        </MenuItem>
      </Popover>
    </>
